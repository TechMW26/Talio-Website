...
export function BlogPage() {
  usePageMeta('Blog', 'Insights, guides, and updates from the Talio team on workforce management, AI automation, HR tech, and building better workplaces.');
      ...
      <section className="relative pt-36 pb-20 md:pt-44 md:pb-28 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 md:px-8">
          <div className="flex flex-col items-center text-center px-6">
            ...
            >
              Deep dives into workforce management, AI automation, product updates, and the future of work.
            </motion.p>
          </div>
          ...
          >
            <div className="flex flex-col items-center text-center">
              ...
              <p className="mt-4 text-gray-400 max-w-lg">
                Get the latest insights on workforce management, AI in HR, and product updates delivered to your inbox.
              </p>
              <div className="mt-8">
                <Link
                  to="/get-started"
