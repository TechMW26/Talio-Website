  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
          ...
          <div className="mt-12 grid gap-4">
            {values.map((value, index) => (
              <motion.div
                ...
                className="rounded-[2rem] border border-white/10 bg-gray-900/50 p-5"
              >
                <div className={`flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br ${value.gradient}`}>
      ...
      <section className="pb-28">
        <div className="mx-auto max-w-7xl px-4 md:px-8 lg:px-12">
          <div className="rounded-[2.5rem] border border-white/10 bg-gradient-to-br from-blue-600 via-purple-600 to-blue-700 p-6 text-center shadow-[0_0_60px_rgba(79,70,229,0.18)]">
